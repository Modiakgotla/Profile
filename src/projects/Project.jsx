   ...
   return (
      <>
         <h2 className="head-text">
            <span style={{color:'#08335F'}}>  Portfolio Section </span>
         </h2>
         <span style={{color:'#08335F'}}> Codetribe Tembisa 2022</span>

         <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', margin:'20px' }}>
         <img class="avatar rounded-2 avatar-user" src="https://avatars.githubusercontent.com/u/104761968?s=64&amp;v=4" size="45" width="45" height="45" alt="@Modiakgotla"/>
            <h2 style={{margin:'5px'}}>
               Rethabile Modiakgotla Magonare
            </h2>
